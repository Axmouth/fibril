...
See also: [core model](/0.4/concepts/core-model/) and
[partition routing](/0.4/development/partition-routing/).
...
See also: [reliability semantics](/0.4/reliability/semantics/) and
[many idle queues](/0.4/concepts/many-idle-queues/).
...
See also: [recovery quarantine](/0.4/reliability/recovery-quarantine/).
...
See also: [client usage](/0.4/clients/) and
[retries and delays](/0.4/reliability/retries-delays/).
...
See also: [backpressure](/0.4/concepts/backpressure/) and
[client usage](/0.4/clients/).
...
See [consumer groups](/0.4/concepts/consumer-groups/) for the user-facing model.
...
See also: [Plexus streams](/0.4/concepts/plexus-streams/) and
[client usage](/0.4/clients/).
...
See also: [reconnects](/0.4/reliability/reconnects/) and
[reconnection grace internals](/0.4/development/reconnection-grace/).
...
See also: [core model](/0.4/concepts/core-model/),
[reliability semantics](/0.4/reliability/semantics/), and
[retries and delays](/0.4/reliability/retries-delays/).
...
See also: [dead lettering](/0.4/reliability/dead-lettering/) and
[metadata policy](/0.4/development/metadata-policy/).
...
See also: [admin dashboard](/0.4/admin-dashboard/) and
[dead lettering](/0.4/reliability/dead-lettering/).
...
See also: [many idle queues](/0.4/concepts/many-idle-queues/) and
[idle queue internals](/0.4/development/idle-queue-internals/).
...
See also: [configuration](/0.4/configuration/),
[configuration policy](/0.4/development/config-policy/), and
[configuration design](/0.4/development/config-design/).
...
See also: [admin dashboard](/0.4/admin-dashboard/).
...
See also: [monitoring](/0.4/deployment/monitoring/).
...
See also: [source deployment](/0.4/deployment/source/) and
[dead lettering](/0.4/reliability/dead-lettering/).
...
See also: [client usage](/0.4/clients/),
[quickstart](/0.4/quickstart/), and
[reconnection grace](/0.4/development/reconnection-grace/).
...
See also: [benchmarks](/0.4/benchmarks/).
...
See also: [source deployment](/0.4/deployment/source/).
...
See also: [configuration](/0.4/configuration/) for the `tls` section fields.
...
See also: [configuration](/0.4/configuration/) for the `auth` section.
...
See also: [clustering](/0.4/concepts/clustering/) and
[replication](/0.4/reliability/replication/).
...
| Repartition cutover fencing | Partial | The controller fences a repartition's finalize (retiring shrunk-away partitions and clearing the marker) on cluster-wide client adoption of the new routing, derived from topology acks, bounded by `repartition_adoption_timeout_ms`. Publish version-fencing remains the correctness backstop. See [live routing and cutover](/0.4/development/live-routing-and-cutover/) |
