...
(() => {
  ...
  const fixtures = {
    overview: { broker: { published_per_sec_1m: 823, delivered_per_sec_1m: 810, acked_per_sec_1m: 806 },
      ...
      storage_usage: { sample: { basis: 'allocated_file_blocks', active_bytes: 104857600, checkpoint_bytes: 2097152, retained_bytes: 33554432, staging_bytes: 4194304, other_bytes: 65536, files: 82, skipped_entries: 0 }, sampled_at_ms: Date.now(), refreshing: false, error: null },
    ...
    'startup-config': { runtime_seed: runtime, data_dir: '/example/fibril-data', broker_bind: '0.0.0.0:9876', admin_bind: '0.0.0.0:8081',
