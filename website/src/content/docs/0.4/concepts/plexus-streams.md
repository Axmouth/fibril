...
slug: 0.4/concepts/plexus-streams
---
...
`stream_replication_factor` (see [Configuration](/0.4/configuration/)); the
...
See [Client usage](/0.4/clients/) for the stream API in Rust, TypeScript, and
Python.
