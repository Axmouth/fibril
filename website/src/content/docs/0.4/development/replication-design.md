...
slug: 0.4/development/replication-design
---

This is a development note. User-facing behavior lives in
[replication](/0.4/reliability/replication/). This page records the internal
...
* [Replication](/0.4/reliability/replication/) for the user-facing model.
* [Clustering](/0.4/concepts/clustering/) for ownership and failover.
* [Recovery quarantine](/0.4/reliability/recovery-quarantine/) for damaged-log handling.
