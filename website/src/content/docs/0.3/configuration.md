...
[clustering](/0.3/concepts/clustering/) and
...
[Plexus streams](/0.3/concepts/plexus-streams/).
...
[live routing and cutover](/0.3/development/live-routing-and-cutover/).
...
See [many idle queues](/0.3/concepts/many-idle-queues/) for the user-facing behavior.
...
See [dead lettering](/0.3/reliability/dead-lettering/) for the setting
