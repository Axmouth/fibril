...
slug: 0.4/development/idle-queue-internals
---

This is a development note. The user-facing behavior is described in [many idle queues](/0.4/concepts/many-idle-queues/).
