...
slug: 0.4/concepts/many-idle-queues
---
...
For the full config reference, see [configuration](/0.4/configuration/).
...
For implementation details, see [idle queue internals](/0.4/development/idle-queue-internals/).
