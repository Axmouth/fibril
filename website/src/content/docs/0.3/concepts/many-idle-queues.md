...
slug: 0.3/concepts/many-idle-queues
---
...
For the full config reference, see [configuration](/0.3/configuration/).
...
For implementation details, see [idle queue internals](/0.3/development/idle-queue-internals/).
