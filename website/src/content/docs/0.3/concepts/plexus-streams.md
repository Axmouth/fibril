...
slug: 0.3/concepts/plexus-streams
---
...
`stream_replication_factor` (see [Configuration](/0.3/configuration/)); the
...
See [Client usage](/0.3/clients/) for the stream API in Rust, TypeScript, and
Python.
