...
configuration: fix `tls_ca_path` or the fingerprint), and `TlsConfig` for
client-side option problems. None of them are retried automatically.

TypeScript and Python TLS options are in progress and will use the same names
and error taxonomy.
