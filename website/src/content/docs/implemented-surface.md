...
| Resource incarnation | Partial | Atomic creation and retirement identities bind recovery and stale deletion checks. Explicit version-two enrollment withholds serving until preparation and activation; ordinary enrollment remains a rollout gate. Legacy migration is deferred |
