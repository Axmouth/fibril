...
For immediate operational inspection, the dashboard combines throughput, backlog and resource history. This example uses sample data; Prometheus remains the durable monitoring history.

<DashboardDemo view="overview" title="Broker health and recent activity" />
