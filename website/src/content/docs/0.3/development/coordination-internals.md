...
slug: 0.3/development/coordination-internals
---

This is a development note. User-facing behavior lives in
[clustering](/0.3/concepts/clustering/) and
[consumer groups](/0.3/concepts/consumer-groups/). This page records how the
...
* [Clustering](/0.3/concepts/clustering/) and [consumer groups](/0.3/concepts/consumer-groups/) for the user-facing model.
* [Replication design](/0.3/development/replication-design/) for the durability side of coordination.
