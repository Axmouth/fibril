...
| Client TLS options | Implemented | Rust, TypeScript, Python, Go, and C#: OS-roots default, CA file, SHA-256 fingerprint pin, server-name override, and the shared typed error taxonomy (426 mismatch vs certificate trust vs config). Python chain pinning needs 3.13, older Pythons pin the leaf |
