...
See also: [core model](/0.3/concepts/core-model/) and
[partition routing](/0.3/development/partition-routing/).
...
See also: [reliability semantics](/0.3/reliability/semantics/) and
[many idle queues](/0.3/concepts/many-idle-queues/).
...
See also: [recovery quarantine](/0.3/reliability/recovery-quarantine/).
...
See also: [client usage](/0.3/clients/) and
[retries and delays](/0.3/reliability/retries-delays/).
...
See also: [backpressure](/0.3/concepts/backpressure/) and
[client usage](/0.3/clients/).
...
See [consumer groups](/0.3/concepts/consumer-groups/) for the user-facing model.
...
See also: [Plexus streams](/0.3/concepts/plexus-streams/) and
[client usage](/0.3/clients/).
...
See also: [reconnects](/0.3/reliability/reconnects/) and
[reconnection grace internals](/0.3/development/reconnection-grace/).
...
See also: [core model](/0.3/concepts/core-model/),
[reliability semantics](/0.3/reliability/semantics/), and
[retries and delays](/0.3/reliability/retries-delays/).
...
See also: [dead lettering](/0.3/reliability/dead-lettering/) and
[metadata policy](/0.3/development/metadata-policy/).
...
See also: [admin dashboard](/0.3/admin-dashboard/) and
[dead lettering](/0.3/reliability/dead-lettering/).
...
See also: [many idle queues](/0.3/concepts/many-idle-queues/) and
[idle queue internals](/0.3/development/idle-queue-internals/).
...
See also: [configuration](/0.3/configuration/),
[configuration policy](/0.3/development/config-policy/), and
[configuration design](/0.3/development/config-design/).
...
See also: [admin dashboard](/0.3/admin-dashboard/).
...
See also: [source deployment](/0.3/deployment/source/) and
[dead lettering](/0.3/reliability/dead-lettering/).
...
See also: [client usage](/0.3/clients/),
[quickstart](/0.3/quickstart/), and
[reconnection grace](/0.3/development/reconnection-grace/).
...
See also: [benchmarks](/0.3/benchmarks/).
...
See also: [source deployment](/0.3/deployment/source/).
...
See also: [configuration](/0.3/configuration/) for the `tls` section fields.
...
See also: [configuration](/0.3/configuration/) for the `auth` section.
...
See also: [clustering](/0.3/concepts/clustering/) and
[replication](/0.3/reliability/replication/).
...
| Repartition cutover fencing | Partial | The controller fences a repartition's finalize (retiring shrunk-away partitions and clearing the marker) on cluster-wide client adoption of the new routing, derived from topology acks, bounded by `repartition_adoption_timeout_ms`. Publish version-fencing remains the correctness backstop. See [live routing and cutover](/0.3/development/live-routing-and-cutover/) |
