...
slug: 0.4/reliability/recovery-quarantine
---
...
dashboard](/0.4/admin-dashboard/), the `/readyz` health endpoint, and a
...
* [Reliability semantics](/0.4/reliability/semantics/) for the durability model.
* [Replication](/0.4/reliability/replication/) for how followers re-fetch a repaired suffix.
* [Configuration](/0.4/configuration/) for the `recovery.on_mismatch` setting.
