...
description: Scrape broker metrics from the admin listener in Prometheus text
  exposition format.
slug: 0.4/deployment/monitoring
---
...
* Recovery health: `fibril_recovery_quarantined` (a gauge - anything above
  ...
  [repair](/0.4/reliability/recovery-quarantine/)) and
...
with [many idle queues](/0.4/concepts/many-idle-queues/) exports series for the
...
[failure modes](/0.4/reliability/failure-modes/) for how they behave under
faults.
