...
slug: 0.4/reliability/semantics
---
...
Short socket breaks can be handled with [reconnect grace](/0.4/reliability/reconnects/) when it is configured and the client reconnects with a valid resume identity before the grace window expires.
