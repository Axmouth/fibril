...
slug: 0.3/reliability/recovery-quarantine
---
...
dashboard](/0.3/admin-dashboard/), the `/readyz` health endpoint, and a
...
* [Reliability semantics](/0.3/reliability/semantics/) for the durability model.
* [Replication](/0.3/reliability/replication/) for how followers re-fetch a repaired suffix.
* [Configuration](/0.3/configuration/) for the `recovery.on_mismatch` setting.
