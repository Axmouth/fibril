...
slug: 0.4/development/recovery-internals
---

This is a development note. User-facing behavior lives in
[recovery quarantine](/0.4/reliability/recovery-quarantine/). This page
...
* [Recovery quarantine](/0.4/reliability/recovery-quarantine/) for the operator view.
* [Replication design](/0.4/development/replication-design/) for the ordering invariants this builds on.
