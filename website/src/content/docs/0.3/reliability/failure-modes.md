...
slug: 0.3/reliability/failure-modes
---
...
[reliability semantics](/0.3/reliability/semantics/),
[replication](/0.3/reliability/replication/),
[recovery quarantine](/0.3/reliability/recovery-quarantine/), and
[reconnects](/0.3/reliability/reconnects/) pages into one incident-time
reference.
...
* Check the [admin queues page](/0.3/admin-dashboard/) for owner and in-sync
  replica status.
...
[recovery quarantine](/0.3/reliability/recovery-quarantine/).
...
* [Reliability semantics](/0.3/reliability/semantics/) - the formal delivery
  and durability guarantees.
* [Replication](/0.3/reliability/replication/) - durability levels, in-sync
  replicas, and failover.
* [Recovery quarantine](/0.3/reliability/recovery-quarantine/) - damaged-log
  handling.
* [Reconnects](/0.3/reliability/reconnects/) - reconnect grace and resume.
* [Configuration](/0.3/configuration/) - the durability, replication, and
