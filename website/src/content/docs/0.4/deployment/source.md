...
seed behavior, and runtime locks, see [configuration](/0.4/configuration/).
...
[TLS](/0.4/configuration/) (supply PEM files or set `tls.auto_self_signed = true`)
...
cluster, see the [cluster setup guide](/0.4/deployment/cluster/). `setup.mode`
