...
| Live topology push | Partial | Broker pushes a `TopologyUpdate` to each connection when the coordination generation changes; the Rust, TypeScript, and Python clients apply it to their routing cache and ack the generation |
