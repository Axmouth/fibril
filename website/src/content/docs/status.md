...
| TLS in transit | Partial | The broker listener serves TLS from operator PEMs or generated per-deployment material, and TLS/plaintext mismatches are named in both directions. Client TLS options and admin dashboard HTTPS are in progress |
