...
## Watch partition placement

<BrokerStory scene="placement" />

[Follow an owner failure and its recovery](/reliability/recovery-sealing/#follow-a-failover)
to see how a new assignment becomes safe to serve.

The dashboard maps partition owners and followers onto registered brokers. Explore this illustrative three-node topology without starting a cluster.

<DashboardDemo view="topology" title="Owners, followers and cluster membership" />
