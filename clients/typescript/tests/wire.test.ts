    ...
    subscriptions: [
      {
        ...
        code: wireModule.REASON_CODES.matched,
        reason: "matched",
      },
      {
        ...
        code: wireModule.REASON_CODES.serverMissing,
...
const CODEC_OP: Record<string, string> = {
  ...
  hello_ok: "HelloOk",
  hello_ok_resumed_after_restart: "HelloOk",
  nack: "Nack",
  nack_no_nb: "Nack",
  publish: "Publish",
...
const CANONICAL: Record<string, unknown> = {
  ...
  hello_ok_resumed_after_restart: {
    ...
    clientId: new Uint8Array(16).fill(8),
    resumeToken: new Uint8Array(16).fill(7),
    resumeOutcome: "resumed_after_restart",
    serverName: "srv",
    compliance: "v=1;x",
  },
  nack: {
  ...
  reconcile_result: {
    subscriptions: [
      ...
      },
      {
        ...
        code: wireModule.REASON_CODES.clientMissing,
  ...
  subscription_closed: {
    subId: 7n,
    code: wireModule.REASON_CODES.ownerMoved,
    message: "partition moved",
  },
  subscribe: {
    topic: "t",
    partition: 1,
