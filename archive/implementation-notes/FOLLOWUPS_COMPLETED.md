...
Design briefs, decisions and validation records for completed work. These notes
retain their original context and are not an active task list. Current behavior
is documented in [implemented surface](../../website/src/content/docs/implemented-surface.md);
remaining work is tracked in [FOLLOWUPS.md](../../FOLLOWUPS.md).
