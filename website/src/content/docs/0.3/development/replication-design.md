...
slug: 0.3/development/replication-design
---

This is a development note. User-facing behavior lives in
[replication](/0.3/reliability/replication/). This page records the internal
...
* [Replication](/0.3/reliability/replication/) for the user-facing model.
* [Clustering](/0.3/concepts/clustering/) for ownership and failover.
* [Recovery quarantine](/0.3/reliability/recovery-quarantine/) for damaged-log handling.
