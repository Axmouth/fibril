...
slug: 0.4/development/coordination-internals
---

This is a development note. User-facing behavior lives in
[clustering](/0.4/concepts/clustering/) and
[consumer groups](/0.4/concepts/consumer-groups/). This page records how the
...
* [Clustering](/0.4/concepts/clustering/) and [consumer groups](/0.4/concepts/consumer-groups/) for the user-facing model.
* [Replication design](/0.4/development/replication-design/) for the durability side of coordination.
