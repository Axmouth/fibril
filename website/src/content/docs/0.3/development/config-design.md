...
slug: 0.3/development/config-design
---

This is a design reference for Fibril configuration. It builds on the [configuration policy](/0.3/development/config-policy/) and tracks both implemented pieces and planned follow-up work.
