...
To stand up a real multi-broker cluster locally and watch ownership, replication, and failover from the admin dashboard, see [try a cluster with Docker](/latest/concepts/clustering/#try-a-cluster-with-docker). Clustering is experimental.
