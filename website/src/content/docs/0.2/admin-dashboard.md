...
The streams page lists the [Plexus](/0.2/concepts/plexus-streams/) stream
...
([cohorts](/0.2/concepts/consumer-groups/)) are in use, it also shows this
...
[clustering](/0.2/concepts/clustering/).
...
quarantine. See [recovery quarantine](/0.2/reliability/recovery-quarantine/).
