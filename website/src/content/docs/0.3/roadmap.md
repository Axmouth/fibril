...
For the reverse view, use [implemented surface](/0.3/implemented-surface/) to
...
completeness. Per-feature maturity lives in [project status](/0.3/status/).
...
[implemented surface](/0.3/implemented-surface/) inventory, and the
[project status](/0.3/status/) exactly as that release shipped them while the root
...
conditions, see [implemented surface](/0.3/implemented-surface/).
...
* Produce repeatable benchmark reports and keep the
  [optimization log](/0.3/development/optimization-log/) current as
...
* Durable broker restart reconciliation. This extends the live-process graceful
  reconnect (see [reconnection grace](/0.3/development/reconnection-grace/))
