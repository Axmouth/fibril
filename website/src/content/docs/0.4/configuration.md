...
[clustering](/0.4/concepts/clustering/) and
...
[Plexus streams](/0.4/concepts/plexus-streams/).
...
node-level aggregates. See [monitoring](/0.4/deployment/monitoring/).
...
[TLS across nodes](/0.4/deployment/cluster/#tls-across-nodes) for the shared-CA
...
[live routing and cutover](/0.4/development/live-routing-and-cutover/).
...
See [many idle queues](/0.4/concepts/many-idle-queues/) for the user-facing behavior.
...
See [dead lettering](/0.4/reliability/dead-lettering/) for the setting
