...
slug: 0.2/concepts/plexus-streams
---
...
`stream_replication_factor` (see [Configuration](/0.2/configuration/)); the
...
See [Client usage](/0.2/clients/) for the stream API in Rust, TypeScript, and
Python.
